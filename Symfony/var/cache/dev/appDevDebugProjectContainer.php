...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'lengow_test' => 'getLengowTestService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \APY\DataGridBundle\APYDataGridBundle A APY\DataGridBundle\APYDataGridBundle instance.
     */
    protected function getGridService()
    {
        $this->services['grid'] = $instance = new \APY\DataGridBundle\APYDataGridBundle();
    ...
    /**
     * Gets the 'lengow_test' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \TestBundle\Controller\XMLController A TestBundle\Controller\XMLController instance.
     */
    protected function getLengowTestService()
    {
        return $this->services['lengow_test'] = new \TestBundle\Controller\XMLController('http://test.lengow.io/orders-test.xml', $this->get('logger'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $d = new \APY\DataGridBundle\Twig\DataGridExtension($b, 'APYDataGridBundle::blocks.html.twig');
        $d->setPagerFanta(array('enable' => false, 'view_class' => 'Pagerfanta\\View\\DefaultView', 'options' => array('prev_message' => '«', 'next_message' => '»')));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c3b2ab1d97ee1b4da98f0562698e10910672415a');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57166d28170693.63063285')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'c3b2ab1d97ee1b4da98f0562698e10910672415a',
            'url_orders' => 'http://test.lengow.io/orders-test.xml',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'c3b2ab1d97ee1b4da98f0562698e10910672415a',
